...
echo "==> Widgets: Audio Wave Widget (fallback visualizer) + date-only readout + globe + cava visualizer"
mkdir -p "$DATA/plasma/plasmoids"
rm -rf "$DATA/plasma/plasmoids/Audio.Wave.Widget" "$DATA/plasma/plasmoids/com.hcristosm.cassettefuturism.datewidget" "$DATA/plasma/plasmoids/com.hcristosm.cassettefuturism.globewidget" "$DATA/plasma/plasmoids/com.hcristosm.cassettefuturism.cavaviz"
...
cp -r "$DOTDIR"/plasmoids/com.hcristosm.cassettefuturism.cavaviz "$DATA/plasma/plasmoids/"
chmod +x "$DATA/plasma/plasmoids/com.hcristosm.cassettefuturism.cavaviz/contents/bin/start_cava.sh"
...
echo "  (cava visualizer needs 'cava' installed — sudo dnf install cava — and isn't added"
echo "   to the layout automatically — add it yourself via Add Widgets)"
